...
/**
 * Controlador Spring MVC para el endpoint de resultados de simulación.
 * Recibe las peticiones HTTP y las delega en {@link ResultadosApiDelegate}.
...
public class ResultadosApiController implements ResultadosApi {
    ...
    /** Delegado que contiene la lógica real del endpoint de resultados. */
