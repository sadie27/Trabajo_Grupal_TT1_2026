...
public class AdvancedSimulationService implements ISimulationService {
    ...
    /**
     * Determina si una célula de {@code color1} puede comerse a una de {@code color2} según la
     * jerarquía avanzada: Red→{Blue,Green}→Yellow. Yellow no come; Red no es comida.
     *
    ...
    /**
     * Ejecuta la lógica avanzada de simulación (compartición de comida azul, jerarquía no circular)
     * y construye la cadena de texto del resultado.
     *
