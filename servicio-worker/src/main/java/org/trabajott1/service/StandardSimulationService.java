 ...
 */
@Service
@ConditionalOnProperty(name = "simulation.mode", havingValue = "standard", matchIfMissing = true)
public class StandardSimulationService implements ISimulationService {

    private static final Logger log = LoggerFactory.getLogger(StandardSimulationService.class);
     ...
     * @version 1.0
     */
    public StandardSimulationService(SolicitudRepository solicitudRepository, EstadisticaPoblacionRepository estadisticaPoblacionRepository) {
